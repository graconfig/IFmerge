@echo off
REM IFmerge - Build Windows executable with PyInstaller
...
echo Building (clean)...
%PY% -m PyInstaller --noconfirm --clean ifmerge.spec
if errorlevel 1 (
    echo.
...
echo ============================================================
echo Output folder: %PROJECT_ROOT%\dist\IFmerge
echo Executable   : %PROJECT_ROOT%\dist\IFmerge\IFmerge.exe
echo.
